...
The idea of this app is to speed up the job description creation process by providing the user with some standard job information to start with. The job information are pulled from the O*NET. 
<br/>
